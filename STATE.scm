...
;; STATE.scm - Project state tracking for asdf-openssh-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-openssh-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-openssh-plugin")
    (repo "hyperpolymath/asdf-openssh-plugin"))
